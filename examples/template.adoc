...
| The file that creates the Redux store, attaches the
  link:../reference/interbit-middleware/README.adoc[Interbit middleware],
...
- link:/reference/interbit-middleware/chainSponsorship.adoc[How
...
link:/reference/interbit-core/README.adoc[`interbit-core`]. When this
