...
used a starting point for building your own Interbit applications. Follow the link:/getting-started/create.md[Getting Start] steps to create your first Interbit app or modify the Template app and start using Interbit UI components.
